...
Note: better solution is to make 2 passes through the matrix (left to right top to bottom & right to left bottom to top) however I wanted to practice implementing a BFS
"""
